...
def run_indexing_script():
    ...
    print("Running the indexing script...")
    try:
        subprocess.run(indexing_command, cwd=os.path.expandvars("$HOME/"), check=True)
        print("Indexing script completed successfully.")
    except subprocess.CalledProcessError as e:
        print(f"Indexing script failed: {str(e)}")
...
try:
    ...
    print("All models started. Running the indexing script...")
    run_indexing_script()
